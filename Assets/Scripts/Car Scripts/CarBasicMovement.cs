...
//     version 1.19.0
//     from Assets/CarBasicMovement.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/CarBasicMovement.inputactions".
/// </summary>
/// <remarks>
...
public partial class @CarBasicMovement: IInputActionCollection2, IDisposable
{
    ...
    ~@CarBasicMovement()
    {
        UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, CarBasicMovement.Player.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, CarBasicMovement.UI.Disable() has not been called.");
    }
    ...
    public struct UIActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public UIActions(@CarBasicMovement wrapper) { m_Wrapper = wrapper; }
        /// <summary>
